## <a id="что-такое-ByeByeDPI">Что такое ByeByeDPI?</a>
...
Если вы по каким-то причинам не хотите докупать приставку к вашему Samsung или LG - рассмотрите другие [варинты](others.md#other-options).
...
## <a id="как-пользоваться-ByeByeDPI">Как пользоваться ByeByeDPI?</a>
...
- Дождитесь окончания подбора. Об успешном окончании будет свидетельствовать список, который называется "Команды с успехом более 50%"[^2]. Вылетает подбор - решение здесь.
...
- В пункте **Фильтр приложений** выберите режим **белого списка** ([подробнее про списки](features.md#белый-и-чёрный))

...
- Использовать ByeByeDPI в качестве локального прокси-сервера. Данный вариант подойдёт, если есть устройство на Android с настроенным ByeByeDPI. Подробная инструкция по подключению [здесь](features.md#раздача-интернета-с-byebyedpi-локальный-прокси)

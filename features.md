...
Допустим у вас есть **iPhone** *(или другое устройство, на которое можно установить прокси-клиент)* и телефон *(или другое устройство, на котором работает ByeByeDPI)* с Android 6.0+.

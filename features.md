...
Допустим у вас есть **iPhone** *(или старый планшет)* и телефон с Android 6.0+.
На телефон установлен ByeByeDPI, подобрана рабочая стратегия. На **iPhone** *(или старый планшет)* ставится прокси-клиент с поддержкой SOCKS5 (например `Happ` подойдёт для iOS и Android).
...
После этого открываем прокси-клиент на **iPhone** *(или старом планшете)*. В примере используется `Happ`.
...
После этого укажем приложения, с которыми должен работать ByeByeDPI на **iPhone** *(или старом планшете)*:

...
Чтобы воспользоваться скриптом, скачайте [файл](https://github.com/HideakiTaiki/ByeByeDPI-Manual/blob/main/automatic_switching.category) и имортируйте его в MacroDroid.

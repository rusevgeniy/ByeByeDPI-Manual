...
<img src="images/Pasted image 20250501114346.png" width="200">

> [!NOTE]
> Можно также приписать к стратегии аргументы: `-G` или `--http-connect` (данные аргументы идентичны по смыслу).
>

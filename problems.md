...
6. [Недавно всё работало, а сейчас не работает](#сейчас-не-работает)
7. [На телевизоре (приставке) пропадает интернет при запуске ByeByeDPI](#пропадает-инет)
8. [Нет звука в Discord](#ds-no-voice)
9. [Высокий процент, но совсем не работает](#высоко-не-работает)
10. [На моём устройстве нельзя использовать режим VPN](#no-vpn)
11. [Очень низкие проценты (выше нуля)](#низкие-проценты)
12. [Не получается обновить или импортировать настройки](#digital-signatur)

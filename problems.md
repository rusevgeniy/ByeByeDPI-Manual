...
Если на устройстве Андроид 10 и новее, то обновите SmartTube до последней версии, попробуйте разные сетевые движки в настройках SmartTube, попробуйте настроить SmartTube в режиме прокси по данной [инструкции](problems.md##no-vpn).
Если все эти действия не помогли: попробуйте перезагрузить устройство и провести [подбор стратегий](sart.md#настройка) заново.

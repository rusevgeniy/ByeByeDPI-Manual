...
4. [Работает только на Wi-Fi или только на мобильном интернете, или только на одном провайдере](#only-one-case)
5. [Не работает какое-либо приложение или сайт при запущенном ByeByeDPI](#something-is-not-working)
6. [Не работает со SmartTube](#smarttube)
7. [Недавно всё работало, а сейчас не работает](#not-working-now)
8. [На телевизоре (приставке) пропадает интернет при запуске ByeByeDPI](#internet-is-lost)
9. [Нет звука в Discord](#ds-no-voice)
10. [Высокий процент, но совсем не работает](#high-not-work)
11. [На моём устройстве нельзя использовать режим VPN](#no-vpn)
12. [Очень низкие проценты (выше нуля)](#low-interest-rates)
